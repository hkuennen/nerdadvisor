...
puts "Creating jobs..."
  ...
  Job.create!({ title: "", desc: "A Senior Technical Level Designer is a solution finder and liaison between level designers and other disciplines. They help with shaping the implementation details of complex locations; as well as, creating and integrating reusable location ingredients into the game themselves. They are advocates for production efficiency and quality for world creation by mentoring others and highlighting constraints.", _type: "Fulltime", startDate: Date.new(2023,02,01), salary: 57000, city: companies[3][:city], user_id: users[3].id, employer_id: employers[2].id })

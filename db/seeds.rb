...
puts "Creating jobs..."
  ...
  Job.create!({ title: "Junior Voice Actor", desc: "Here at Player One Trailers, we strive to tell stories within existing and new video game worlds. Want to voice our next project? You're in luck! We are looking to expand our talent roster of male and female voice actors to work with our lead Creative Director in voicing our work on a per-project basis. Can work remotely.", _type: "Fulltime", startDate: Date.new(2022,12,01), salary: 60000, city: companies[1][:city], user_id: users[2].id, employer_id: employers[3].id })

  Job.create!({ title: "German Voice Actor GTA", desc: "Are you based in Berlin and interested in video games? Do you want to put rough German voices for our mafia characters? We are currently seeking German native voice actors in Berlin to provide video game voice over. Voice acting for video game voice over recording. Independently recording demo samples at home when considered for a role. Interpreting scripts, deciphering characters, following the instructions of an artistic director and delivering believable performances Requirements: Native German (Berlin). We know you're a tough young man and you can make it.", _type: "Fulltime", startDate: Date.new(2022,12,01), salary: 60000, city: companies[2][:city], user_id: users[3].id, employer_id: employers[0].id })

...
puts "Creating jobs..."
  ...
  Job.create!({ title: "Senior Animator", desc:"The animation department is a small hub of creative and hardworking artists from many diverse backgrounds where professionalism, trust, and fun rub shoulders every day. The animation department is currently growing and looking to onboard new teammates. We are looking forward to new projects with new challenges and high-quality work deliveries.", _type: "Fulltime", startDate: Date.new(2023,02,01), salary: 43700, city: ea.city, user_id: aj.id, employer_id: ea.id })

  Job.create!({ title: "Roto Paint Artist", desc: "Paint out rigs and wires using Nuke and other relevant software", _type: "Parttime", startDate: Date.new(2023,02,01), salary: 36700, city: nintendo.city, user_id: adi.id, employer_id: nintendo.id })
